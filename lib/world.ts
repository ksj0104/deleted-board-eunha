...
export const deliveries = [
  ...
  },
  {
    ...
    source: "입주자 감사 경유 회신 · 설비 점검표 · CCTV 보관 캡처 · 출입·전력 기록",
  },
  {
    episode: 3,
    date: "03.21 09:00",
    ...
    body: "보내 주신 시간 대조 결과를 읽었습니다. 서윤 씨와 공유하던 공사비 자료의 보관 사본을 보냅니다. 공개 결산의 작업번호를 업체 회신·이체 확인서·협력업체 등록부와 맞춰 주세요. 결산 수정을 요청한 쪽지도 함께 보존했습니다. 금액이 다르다는 사실과 누가 실제로 받았다는 사실을 구분해 주셨으면 합니다. 사본을 최종 근거로 쓰기 전에는 은행과 업체가 보관한 원본으로 다시 확인해 주세요.",
    source: "공사비 자료 보관 사본 · 업체 수신 회신 · 결산 수정 요청 쪽지",
  },
  {
    episode: 4,
    date: "03.22 18:00",
