...
export const deliveries = [
  ...
  },
  {
    ...
    body: "모임은 취소됐어도 개인 약속은 그대로라 가게에서 기다렸습니다. 서윤 씨는 오지 않았고 이후 직접 통화하지도 못했어요. 함께 요청한 기록 보존 건을 입주자 감사가 접수했고, 설비 담당자와 보안업체에서 해당 시간대의 회신을 받았습니다. 카드 등록자 정보는 아직 제외되어 있습니다. C2 점검표와 출입·전력 기록을 주민마당의 유출 안내와 비교해 주세요. 안부 요청도 계속 전달하겠습니다.",
    source:
      "입주자 감사 경유 회신 · 설비 점검표 · CCTV 보관 캡처 · 출입·전력 기록",
  },
  {
    episode: 3,
    date: "03.21 09:00",
    ...
    body: "보내 주신 시간 대조 결과를 읽었습니다. 서윤 씨와 공유하던 공사비 자료의 보관 사본을 보냅니다. 공개 결산의 작업번호를 업체 회신·이체 확인서·협력업체 등록부와 맞춰 주세요. 파쇄기 목격담에 따라 입주자 감사가 19일 지하 파쇄함의 폐지를 봉인했고, 어제 분류한 결산 수정 쪽지의 여섯 묶음도 인계받았습니다. 종이 조각을 이어 공개본에서 무엇이 바뀌었는지 확인해 주세요. 이 종이만으로 파쇄한 사람을 단정할 수는 없습니다. 사본을 최종 근거로 쓰기 전에는 은행과 업체의 원본으로 다시 확인해 주세요.",
    source:
