...
export const investigations: Investigation[] = [
  ...
  },
  {
    ...
    title: "지급 전표 대조대",
    instruction:
      "같은 작업번호의 결산서와 계산서를 펼치고, 이체 전표를 해당 지급 칸에 놓으세요. 남은 지급의 계좌와 승인 서명을 업체 등록 카드까지 이어 보세요.",
  ...
  },
  {
    ...
    title: "방문증 동선 지도",
    instruction:
      "리더 기록을 지도 위 장소에 놓고 시각 순서로 길을 이으세요. 공사 구간을 표시하고, 마지막 장소의 비상문을 정전 상태에서 조작해 확인하세요.",
